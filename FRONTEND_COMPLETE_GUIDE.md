...
cp ../agent-service/contracts/StoryProtocolCore.json src/contracts/abis/
cp ../agent-service/contracts/SPG.json src/contracts/abis/
cp ../agent-service/contracts/IPAssetRegistry.json src/contracts/abis/
```
