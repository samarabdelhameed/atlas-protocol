...
import { Shield, Scan, CheckCircle2, AlertCircle, Sparkles, Settings, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black pt-24 pb-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-5xl font-bold text-white mb-4">Create Your Atlas Data Vault</h1>
          <p className="text-gray-400 text-lg">
            Activate your IP as a Dynamic Data Asset & Verify Provenance with World ID
          </p>
        </motion.div>
        ...
        >
          {step === 1 && (
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">1. Select Your Story Protocol IP Asset</h2>
                  <p className="text-gray-400 text-sm">Connect your registered IP from Story Protocol</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-2">
                    Enter the unique identifier for your IP asset registered on Story Protocol
                  </p>
                </div>
                ...
                {ipAssetId && !isValidating && !validationSuccess && (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-blue-400 text-sm font-medium mb-1">Ready to Validate</p>
                        <p className="text-gray-400 text-sm">
                          Click below to verify this IP asset exists on Story Protocol and is owned by your connected wallet
                        </p>
                      </div>
                    </div>
                  </motion.div>
                ...
                {isValidating && (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-amber-400 text-sm font-medium">Fetching IP details from Story Protocol...</p>
                      </div>
                    </div>
                  </motion.div>
                )}
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-green-400 text-sm font-bold mb-2">IP Asset Validated Successfully!</p>
                        <div className="space-y-1">
                          <p className="text-white text-sm font-medium">My Awesome Song</p>
                          <p className="text-gray-400 text-xs">Music IP • Registered 3 months ago • 1,247 licenses issued</p>
                          <p className="text-gray-500 text-xs">Owned by: {ipAssetId.slice(0, 6)}...{ipAssetId.slice(-4)}</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                <motion.button
                  ...
                  disabled={!ipAssetId || isValidating || validationSuccess}
          ...
          {step === 2 && (
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">2. Verify Human Identity (World ID)</h2>
                  <p className="text-gray-400 text-sm">Establish provenance and prevent Sybil attacks</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="p-6 bg-gradient-to-r from-violet-500/10 to-pink-500/10 border border-orange-500/30 rounded-2xl">
                  <div className="text-center">
                    ...
                    <h3 className="text-white font-bold text-xl mb-2">World ID Verification Required</h3>
                    <p className="text-gray-400 text-sm mb-6 max-w-md mx-auto leading-relaxed">
                      To ensure data authenticity and prevent Sybil attacks, verify that you are a unique human using World ID.
                      This establishes cryptographic proof of provenance for your IP vault.
                    </p>
                    ...
                    {!isVerified ? (
                      ...
                      >
                        <div className="flex items-center justify-center gap-2 text-green-400">
                          ...
                          <span className="font-bold text-lg">Identity Verified Successfully!</span>
                        </div>
                        <p className="text-gray-400 text-sm">
                          World ID proof recorded. Proceeding to vault configuration...
                        </p>
                      </motion.div>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    { label: 'Proof-of-Provenance', desc: 'Cryptographic authenticity' }
                  ].map((benefit, idx) => (
                    <motion.div
                      key={benefit.label}
                      initial={{ opacity: 0, y: 20 }}
                    ...
                    >
                      ...
                      <p className="text-white text-sm font-medium mb-1">{benefit.label}</p>
          ...
          {step === 3 && (
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">3. Configure Your Vault Terms</h2>
                  <p className="text-gray-400 text-sm">Set default parameters for CVS-backed loans</p>
                </div>
              </div>
                ...
                <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        These are default terms that can be adjusted for each individual loan request.
                        Your actual borrowing capacity will be determined by your real-time CVS score.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {step === 4 && (
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">4. Review & Deploy Your Vault</h2>
                  <p className="text-gray-400 text-sm">Final confirmation before deployment</p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="p-5 bg-gray-900/50 rounded-xl border border-gray-700/50">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-white font-mono text-sm">{ipAssetId}</p>
                    </div>
                ...
                <div className="p-5 bg-gray-900/50 rounded-xl border border-gray-700/50">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-gray-400 text-sm mb-1">World ID Status</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-5 bg-gray-900/50 rounded-xl border border-gray-700/50">
                    <p className="text-gray-400 text-sm mb-1">Default Duration</p>
                ...
                <div className="p-5 bg-gray-900/50 rounded-xl border border-gray-700/50">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-gray-400 text-sm mb-1">Initial CVS Score</p>
                      <p className="text-amber-400 font-bold text-lg">5,000</p>
                    </div>
                    <div className="text-right">
                      <p className="text-gray-400 text-sm mb-1">Est. Max Borrowable</p>
              ...
              {isDeploying && (
                ...
                >
                  <div className="flex items-center gap-3">
                    <Loader2 className="w-5 h-5 text-amber-400 animate-spin" />
                    <div>
                      <p className="text-amber-400 text-sm font-medium">Transaction in progress...</p>
          ...
          {step === 5 && (
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-white mb-3">Atlas Vault Deployed Successfully!</h2>
              <p className="text-gray-400 mb-8">Your IP Data Vault is now active and ready to generate liquidity</p>
